...
final class TypeFloatTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = \Mediadevs\Validator\Filters\Basic\TypeFloat::class;
    }

    /**
     * @test Expects the results returned to be (TRUE).
     * @testdox Whether [Basic\TypeFloat] will pass the validation with the correct input.
     *
     * @throws Exception
     *
     * @return void
     ...
     * @testdox Whether [Basic\TypeFloat] will fail the validation with the incorrect input.
     *
     * @throws Exception
     *
     * @return void
