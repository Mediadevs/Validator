...
final class NotEqualTest extends TestCase
{
     ...
     * @testdox Whether [Basic\NotEqual] will pass the validation with the correct input.
     *
     * @throws Exception
     *
     * @return void
     ...
     * @testdox Whether [Basic\NotEqual] will fail the validation with the incorrect input.
     *
     * @throws Exception
     *
     * @return void
