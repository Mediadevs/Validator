...
final class TypeStringTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = \Mediadevs\Validator\Filters\Basic\TypeString::class;
    }

    /**
     * @test Expects the results returned to be (TRUE).
     * @testdox Whether [Basic\TypeString] will pass the validation with the correct input.
     *
     * @throws Exception
     *
     * @return void
     ...
     * @testdox Whether [Basic\TypeString] will fail the validation with the incorrect input.
     *
     * @throws Exception
     *
     * @return void
