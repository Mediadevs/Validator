...
final class TypeBooleanTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = \Mediadevs\Validator\Filters\Basic\TypeBoolean::class;
    }

    /**
     * @test Expects the results returned to be (TRUE).
     * @testdox Whether [Basic\TypeBoolean] will pass the validation with the correct input.
     *
     * @throws Exception
     *
     * @return void
     ...
     * @testdox Whether [Basic\TypeBoolean] will fail the validation with the incorrect input.
     *
     * @throws Exception
     *
     * @return void
