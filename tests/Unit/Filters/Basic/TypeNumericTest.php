...
final class TypeNumericTest extends TestCase
{
     ...
     * @testdox Whether [Basic\TypeNumeric] will pass the validation with the correct input.
     *
     * @throws Exception
     *
     * @return void
     ...
     * @testdox Whether [Basic\TypeNumeric] will fail the validation with the incorrect input.
     *
     * @throws Exception
     *
     * @return void
